...
public class Game : MonoBehaviour
{
    ...
    private void Flag()
    {
        ...
        // wenn revealed dann kann nicht flagged
    ...
    private void Reveal()
    {
        ...
        // kann nicht revealed werden wenn bereits revealed oder flagged
    ...
    private void Flood(Cell cell)
    {
        ...
        // wenn empty, rundherum auch revealen + schauen ob empty usw.
    ...
    private void CheckWinCondition()
    {
        for (int x = 0; x < width; x++)
        {
            for (int y = 0; y < height; y++)
            {
                ...
                // wenn alle minen flagged sind dann ist spiel vorbei
